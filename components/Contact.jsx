...
const Contact = ({isDarkMode}) => {
    ...
    formData.append("access_key", "7ee1308c-f292-4190-b43f-04e9d3a6c596");
...
return (
  <div
    id="contact"
    className="w-full px-[12%] py-10 scroll-mt-6"
  >
    {/* Header */}
      ...
      <div className="bg-white/80 dark:bg-black/10 backdrop-blur-xl border border-gray-300/30 dark:border-gray-600/30 rounded-3xl p-6 md:p-8 shadow-2xl">
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="flex justify-center pt-2">
            <button
              className={`w-max flex items-center justify-center gap-2 border border-gray-700 rounded-full py-2 px-20 mx-auto dark:bg-black/50 bg-slate-100/50 hover:dark:bg-black hover:bg-slate-100 hover:scale-110 hover-bounce-continuous duration-400 cursor-pointer transition-all ${isDarkMode ? 'text-white' : 'text-black'}`}
              type="submit"
            >
