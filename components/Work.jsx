...
const Work = ({ isDarkMode }) => {
  ...
  return (
    <div id="mywork" className="w-full px-[12%] py-15 scroll-mt-4">
      ...
      <p className="text-center max-w-6xl mx-auto mt-5 mb-12 font-outfit">
        ...
        >
          <div className="flex">
            {[...cardData, ...cardData].map((card, index) => (
              <div
                key={index}
                className="w-[28rem] h-[16rem] mx-4 relative group rounded-lg overflow-hidden shadow-lg"
              >
                  ...
                  <div className="w-full h-full  rounded-lg overflow-hidden bg-white dark:bg-gray-900">
                    ...
                    <div className="absolute inset-0 bg-black/70 dark:bg-black/90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-center items-center text-center p-4 z-10">
                      ...
                      <a
                          ...
                          className="flex items-center justify-center gap-2 border border-gray-300 rounded-full py-2 px-6 text-sm dark:bg-black bg-slate-100 opacity-65 hover:opacity-100 hover:scale-110 duration-300 cursor-pointer transition-all"
                        >
                          Live Preview
                        </a>
                    </div>
