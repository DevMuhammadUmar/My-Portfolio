...
const Header = ({ isDarkMode }) => {
  return (
    <div id="home" className="h-[580px] flex flex-col items-center justify-center px-4 text-center">
   ...
   Hello my name is
    ...
    <h1 className="text-5xl mt-10 sm:text-7xl md:text-9xl font-extrabold text-transparent bg-clip-text 
...
{/* Role + Location */}
<p className="text-lg sm:text-2xl text-gray-700 mt-4 dark:text-white ">
